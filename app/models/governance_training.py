...
class TrainingCourse(Base):
    ...
    records = relationship("GovernanceTrainingRecord",
                            back_populates="course",
                            cascade="all, delete-orphan")
    assignments = relationship("TrainingAssignment",
                                back_populates="course",
                                cascade="all, delete-orphan")
...
class GovernanceTrainingRecord(Base):
    ...
    assignment = relationship("TrainingAssignment", back_populates="records",
