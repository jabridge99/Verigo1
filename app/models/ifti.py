...
class IFTIRecord(Base):
    ...
    # ── Transaction details ───────────────────────────────────────────────────
    date_received   = Column(Date, nullable=False)   # Date money/property received from ordering customer
    ...
    accept_id_number    = Column(String(100))   # IFTI-OUT: retail outlet ID / IFTI-IN: same field
