...
class Transaction(Base):
    ...
    is_near_threshold       = Column(Boolean, default=False)    # within 10% of reporting threshold
...
class CustomerBehaviourProfile(Base):
    ...
    high_risk_country_count     = Column(Integer, default=0)    # transactions to/from high-risk
