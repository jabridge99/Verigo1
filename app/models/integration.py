...
PROVIDER_CATALOG: list[dict] = [
    # KYC
    {
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "AI-powered identity verification: document check, facial biometric, liveness detection",
    },
    {
        "slug": "jumio",
        "name": "Jumio",
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "End-to-end identity proofing and eKYC",
    },
    {
        "slug": "veriff",
        "name": "Veriff",
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "Video-first identity verification with automated decision engine",
    },
    {
        "slug": "idnow",
        "name": "IDnow",
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "European eIDAS-compliant identity verification",
    },
    {
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "Identity verification integrated with Stripe payment ecosystem",
    },
    # Screening
    {
        "slug": "refinitiv",
        ...
        "type": "enterprise_api",
        "auth": "api_key",
        "description": "PEP, sanctions, and adverse media database",
    },
    {
        "slug": "dow_jones",
    ...
    },
    {
        ...
        "type": "open_source",
        "auth": "none",
        "description": "Open-source global sanctions and PEP database",
    },
    {
        "slug": "chainalysis",
    ...
    {
        "slug": "abr",
        "name": "ABR (Australian Business Register)",
    ...
    },
    {
        ...
        "type": "free_api",
        "auth": "none",
        "description": "ASIC company and officer lookup (public data)",
    },
    {
        "slug": "opencorporates",
        "name": "OpenCorporates",
        ...
        "type": "free_api",
        "auth": "api_key",
        "description": "Global company registry aggregator (180+ jurisdictions)",
    },
    {
        "slug": "dnb",
        "name": "Dun & Bradstreet",
        ...
        "type": "enterprise_api",
        "auth": "oauth2",
        "description": "Global business identity and credit data",
    },
    # Address Validation
    {
        "slug": "google_places",
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "Address autocomplete, geocoding, and validation",
    },
    {
        "slug": "australia_post",
        ...
        "type": "free_api",
        "auth": "api_key",
        "description": "Australian postal address validation and lookup",
    },
    {
        "slug": "loqate",
        "name": "Loqate Address Verify",
        "category": "address_validation",
        "type": "premium_api",
        "auth": "api_key",
        "description": "Global address verification and geocoding",
    },
    # Credit & Financial Intelligence
    {
        "slug": "equifax_au",
        ...
        "type": "enterprise_api",
        "auth": "oauth2",
        "description": "Individual and commercial credit reports (Australia)",
    },
    {
        "slug": "illion",
        "name": "illion (Dun & Bradstreet AU)",
        "category": "credit_financial",
        "type": "enterprise_api",
        "auth": "api_key",
        "description": "Business credit bureau and financial intelligence",
    },
    {
        "slug": "creditsafe",
        "name": "CreditSafe",
    ...
    # CRM
    {
        ...
        "type": "enterprise_api",
        "auth": "oauth2",
        "description": "Enterprise CRM — sync customers and compliance tasks",
    },
    {
        "slug": "zoho_crm",
        "name": "Zoho CRM",
        ...
        "type": "premium_api",
        "auth": "oauth2",
        "description": "Cloud CRM with AML workflow integration",
    },
    {
        "slug": "hubspot",
        "name": "HubSpot",
    ...
    },
    {
        ...
        "type": "premium_api",
        "auth": "api_key",
        "description": "Work OS — compliance task and workflow management",
    },
    {
        "slug": "pipedrive",
        "name": "Pipedrive",
    ...
    # Storage
    {
        ...
        "type": "free_api",
        "auth": "oauth2",
        "description": "Microsoft cloud document storage",
    },
    {
        "slug": "dropbox",
    ...
    },
    {
        ...
        "type": "custom_api",
        "auth": "basic_auth",
        "description": "Secure FTP server for document transfer",
    },
    # Communications
    {
        "slug": "sendgrid",
    ...
    },
    {
        ...
        "type": "enterprise_api",
        "auth": "oauth2",
        "description": "Teams webhook for compliance notifications",
    },
    {
        "slug": "slack",
        "name": "Slack",
        ...
        "type": "free_api",
        "auth": "api_key",
        "description": "Slack webhook or app for compliance alerts",
    },
    {
