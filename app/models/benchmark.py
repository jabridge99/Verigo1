...
from sqlalchemy import (
    ...
    ForeignKey, Integer, JSON, String, func,
)
...
METRIC_META = {
    "smr_rate_per_1k":          {"label": "SMR Rate (per 1,000 customers)",     "unit": "per 1k",  "higher_is_better": False},
    ...
    "alert_to_smr_pct":          {"label": "Alert → SMR Conversion",            "unit": "%",       "higher_is_better": None},
    "training_completion_pct":   {"label": "Training Completion Rate",           "unit": "%",       "higher_is_better": True},
    "training_overdue_pct":      {"label": "Training Overdue Rate",              "unit": "%",       "higher_is_better": False},
    "high_risk_customer_pct":    {"label": "High/Critical Risk Customers",       "unit": "%",       "higher_is_better": False},
    "edd_escalation_pct":        {"label": "EDD Escalation Rate",                "unit": "%",       "higher_is_better": None},
    "cdd_completion_pct":        {"label": "CDD Completion Rate",                "unit": "%",       "higher_is_better": True},
    "open_alert_pct":            {"label": "Open Alert Rate",                    "unit": "%",       "higher_is_better": False},
    "policy_review_on_time_pct": {"label": "Policy Review On-Time Rate",         "unit": "%",       "higher_is_better": True},
    "control_effectiveness_pct": {"label": "Control Effectiveness Rate",         "unit": "%",       "higher_is_better": True},
    "avg_case_days":             {"label": "Avg Case Resolution Time",           "unit": "days",    "higher_is_better": False},
    "pep_customer_pct":          {"label": "PEP Customer Rate",                  "unit": "%",       "higher_is_better": None},
    "sanctions_match_pct":       {"label": "Sanctions Match Rate",               "unit": "%",       "higher_is_better": None},
    "total_customers":           {"label": "Total Customers",                    "unit": "count",   "higher_is_better": None},
}
