...
DEFAULT_CHECKLISTS: dict[str, list[dict]] = {
    "accountant": [
        ...
        {"key": "sow_understood",          "label": "Source of Wealth understood and documented"},
        {"key": "tax_docs_reviewed",       "label": "Tax documentation reviewed"},
        {"key": "beneficial_ownership",    "label": "Beneficial ownership identified and verified"},
        {"key": "purpose_documented",      "label": "Purpose of transaction documented"},
        {"key": "client_risk_reviewed",    "label": "Client risk rating reviewed"},
        {"key": "escalation_considered",   "label": "Escalation to Compliance Officer considered"},
        {"key": "smr_considered",          "label": "SMR assessment considered"},
    ],
    "tax_adviser": [
        {"key": "sof_understood",          "label": "Source of Funds understood and documented"},
        {"key": "sow_understood",          "label": "Source of Wealth understood and documented"},
        {"key": "income_consistency",      "label": "Declared income consistent with transaction value"},
        {"key": "offshore_structures",     "label": "Offshore structures reviewed for commercial purpose"},
        {"key": "tax_residency_verified",  "label": "Tax residency status verified"},
        {"key": "beneficial_ownership",    "label": "Beneficial ownership of entities identified"},
        {"key": "purpose_documented",      "label": "Purpose of transaction documented"},
        {"key": "escalation_considered",   "label": "Escalation to Compliance Officer considered"},
    ],
    "lawyer": [
        ...
        {"key": "third_party_payments",    "label": "Third-party payments reviewed and justified"},
    ...
    "conveyancer": [
        ...
        {"key": "purchaser_identified",    "label": "Purchaser identity verified (KYC/KYB complete)"},
        {"key": "sof_reviewed",            "label": "Source of Funds reviewed"},
        {"key": "third_party_payments",    "label": "Third-party payments assessed"},
        {"key": "foreign_ownership",       "label": "Foreign ownership considerations reviewed (FIRB)"},
        {"key": "beneficial_ownership",    "label": "Beneficial ownership of purchasing entity identified"},
        {"key": "purpose_documented",      "label": "Purpose of transaction documented"},
        {"key": "escalation_considered",   "label": "Escalation to Compliance Officer considered"},
    ],
    "tcsp": [
        {"key": "beneficial_ownership",    "label": "Beneficial ownership of structure fully identified"},
        {"key": "sof_understood",          "label": "Source of Funds for structure contributions understood"},
        {"key": "sow_understood",          "label": "Source of Wealth of underlying controllers understood"},
        {"key": "purpose_documented",      "label": "Commercial or personal purpose of structure documented"},
        {"key": "controller_verified",     "label": "Controllers and settlors verified"},
        {"key": "offshore_nexus",          "label": "Offshore connections reviewed for commercial rationale"},
    ...
    "real_estate": [
        ...
        {"key": "beneficial_ownership",    "label": "Beneficial ownership of purchasing entity identified"},
        {"key": "third_party_payments",    "label": "Third-party payments assessed"},
        {"key": "foreign_ownership",       "label": "Foreign ownership considerations reviewed"},
        {"key": "transaction_structure",   "label": "Transaction structure assessed for complexity"},
...
class ProfessionalAssessment(Base):
    ...
    status              = Column(Enum(AssessmentStatus), default=AssessmentStatus.draft,
                                 nullable=False, index=True)
    overall_risk_rating = Column(Enum(AssessmentRiskRating), default=AssessmentRiskRating.not_rated)
    ...
    # Relationships
    sof_assessment      = relationship("SOFAssessment", back_populates="assessment",
                                       uselist=False, cascade="all, delete-orphan")
    sow_assessment      = relationship("SOWAssessment", back_populates="assessment",
                                       uselist=False, cascade="all, delete-orphan")
    purpose_assessment  = relationship("TransactionPurposeAssessment", back_populates="assessment",
                                       uselist=False, cascade="all, delete-orphan")
    tax_risk_assessment = relationship("TaxRiskAssessment", back_populates="assessment",
                                       uselist=False, cascade="all, delete-orphan")
    investment_assessment = relationship("InvestmentLegitimacyAssessment",
                                         back_populates="assessment",
                                         uselist=False, cascade="all, delete-orphan")
    checklist           = relationship("ProfessionalJudgmentChecklist", back_populates="assessment",
                                       uselist=False, cascade="all, delete-orphan")
...
class SOFAssessment(Base):
    ...
    assessment_id   = Column(String, ForeignKey("professional_assessments.id", ondelete="CASCADE"),
...
class TransactionPurposeAssessment(Base):
    ...
    assessment = relationship("ProfessionalAssessment", back_populates="purpose_assessment")
...
class TaxRiskAssessment(Base):
    ...
    custom_indicators   = Column(JSON, default=list)    # [{"label": "...", "present": true}]
    ...
    risk_rating         = Column(Enum(AssessmentRiskRating), default=AssessmentRiskRating.not_rated)
    reviewer_id         = Column(String)
    review_date         = Column(DateTime(timezone=True))
    ...
    assessment = relationship("ProfessionalAssessment", back_populates="tax_risk_assessment")
...
class InvestmentLegitimacyAssessment(Base):
    ...
    review_outcome_status    = Column(Enum(ReviewOutcome), default=ReviewOutcome.not_reviewed)
    reviewer_id              = Column(String)
    review_date              = Column(DateTime(timezone=True))
    review_notes             = Column(Text)
    ...
    assessment = relationship("ProfessionalAssessment", back_populates="investment_assessment")
