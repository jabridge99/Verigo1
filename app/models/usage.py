...
class UsageRecord(Base):
    ...
    customer_id = Column(String, index=True)   # the end-customer being verified, if applicable
    ...
    status = Column(Enum(UsageRecordStatus), default=UsageRecordStatus.pending, nullable=False, index=True)
