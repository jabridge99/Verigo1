...
def _fbs_detail(txn, customer) -> dict:
    ...
    return {
        ...
        "customer_suburb": getattr(customer, "suburb", None) or getattr(customer, "city", None),
        ...
        "money_received_aud_cash": _fmt_amount(getattr(txn, "amount_aud", None) or getattr(txn, "amount", None)) if _infer_cash_type(txn) in ("cash_deposit", "cash_exchange") else None,
        "money_received_foreign_currency_code": currency if is_foreign else None,
        "money_received_foreign_amount": _fmt_amount(getattr(txn, "amount", None)) if is_foreign else None,
        ...
        "money_provided_aud_cash": _fmt_amount(getattr(txn, "amount_aud", None) or getattr(txn, "amount", None)) if _infer_cash_type(txn) in ("cash_withdrawal", "cash_exchange") else None,
        ...
        "account_title": getattr(txn, "source_account_name", None) or getattr(txn, "destination_account_name", None),
...
def _msb_detail(txn, customer) -> dict:
    ...
    return {
        ...
        "sender_suburb": getattr(customer, "suburb", None) or getattr(customer, "city", None),
...
_COMMON_COLUMNS = [
    # Report metadata
    "report_ref", "industry_type", "status", "due_date", "prepared_by",
    # Transaction
    "transaction_date", "total_amount_aud", "transaction_type", "currency",
    # Customer (core)
    "customer_name", "customer_dob",
    "customer_address", "customer_suburb", "customer_state",
    "customer_postcode", "customer_country",
    "customer_occupation", "customer_abn",
...
_INDUSTRY_EXTRA_COLUMNS: dict[TTRIndustryType, list[str]] = {
    TTRIndustryType.FBS: [
        ...
        "designated_svc",
        "method_of_conducting_txn", "method_other_description",
        ...
        "customer_id_type_code", "customer_id_issuer", "customer_id_country",
        "customer_ind_occ_type", "customer_ind_occ_code", "customer_ind_occ_description",
        # Cash
        "cash_type",
        "money_received_aud_cash",
        "money_received_foreign_currency_code", "money_received_foreign_amount",
        # Non-cash received
        "non_cash_received_fai", "non_cash_received_iti", "non_cash_received_dti",
        "non_cash_received_chi", "non_cash_received_bci", "non_cash_received_bdi",
        "non_cash_received_tci", "non_cash_received_moi", "non_cash_received_bui",
        "non_cash_received_svi", "non_cash_received_oti_desc", "non_cash_received_oti_amount",
        # Non-cash provided
        "money_provided_aud_cash",
        "non_cash_provided_fao", "non_cash_provided_ito", "non_cash_provided_dto",
        "non_cash_provided_buo", "non_cash_provided_sto",
        "non_cash_provided_oto_desc", "non_cash_provided_oto_amount",
        # Account
        "account_title", "account_bsb",
        # FX / Bullion
        "is_foreign_currency", "foreign_currency_code", "exchange_rate",
        "bullion_type", "bullion_weight_grams", "bullion_purity", "bullion_spot_price_aud",
        # Other
        "service_channel", "is_structured_transaction", "structuring_notes",
    ],
    TTRIndustryType.GS: [
        "designated_svc",
        "method_of_conducting_txn", "method_other_description",
        ...
        "venue_name", "venue_address", "venue_suburb", "venue_state", "venue_postcode",
        "gaming_licence_number", "gaming_area",
        "patron_id", "patron_membership_number",
        "gambling_txn_direction",
        "cash_aud_received", "cash_aud_provided",
        "cash_contra_aud_received", "cash_contra_aud_provided",
        "non_cash_received_fai", "non_cash_received_gci", "non_cash_received_egi",
        "non_cash_received_oci", "non_cash_received_cri", "non_cash_received_wti",
        "non_cash_received_svi", "non_cash_received_oti_desc", "non_cash_received_oti_amount",
        "non_cash_provided_fao", "non_cash_provided_ito", "non_cash_provided_gco",
        "non_cash_provided_bio", "non_cash_provided_bpo", "non_cash_provided_mro",
        "non_cash_provided_cho", "non_cash_provided_sio",
        "non_cash_provided_oto_desc", "non_cash_provided_oto_amount",
        "account_title", "account_number",
        "game_type", "table_number", "machine_number",
        "chip_denomination", "chip_count",
        "is_multiple_transactions", "multiple_transaction_notes",
    ],
    TTRIndustryType.ISI: [
        "designated_svc",
        "method_of_conducting_txn", "method_other_description",
        ...
        "customer_id_type_code", "customer_id_issuer", "customer_id_country",
        "customer_ind_occ_description",
        "policy_number", "account_reference",
        "fund_name", "trustee_name", "trustee_abn",
        "product_provider_name", "product_provider_abn",
        "contribution_type", "investment_type", "financial_year",
        "non_cash_received_fai", "non_cash_received_dti",
        "non_cash_received_chi", "non_cash_received_bci", "non_cash_received_bdi",
        "non_cash_received_bpi", "non_cash_received_dfi", "non_cash_received_sei",
        "non_cash_received_eci_description", "non_cash_received_eci_amount",
        "non_cash_received_oti_desc", "non_cash_received_oti_amount",
        "non_cash_provided_fao", "non_cash_provided_dto", "non_cash_provided_cho",
        "non_cash_provided_cpo", "non_cash_provided_dfo", "non_cash_provided_seo",
        "non_cash_provided_eco_description", "non_cash_provided_eco_amount",
        ...
        "rollover_from_fund", "rollover_from_abn",
        "tax_file_number_provided", "concessional_contribution",
    ],
    TTRIndustryType.MSB: [
        "designated_svc",
        "method_of_conducting_txn", "method_other_description",
        ...
        "sender_name", "sender_dob",
        "sender_address", "sender_suburb", "sender_state", "sender_postcode", "sender_country",
        "sender_phone", "sender_id_type", "sender_id_number", "sender_id_country",
        "receiver_name", "receiver_address", "receiver_suburb", "receiver_country",
        "receiver_phone", "receiver_dob",
        "receiver_account_title", "receiver_account_number", "receiver_account_type",
        "non_cash_received_cheque_amount", "non_cash_received_cheque_drawer",
        "non_cash_received_money_order", "non_cash_received_travellers_cheque",
        "non_cash_received_remittance", "non_cash_received_stored_value_card",
        "non_cash_received_ecurrency_desc", "non_cash_received_ecurrency_amount",
        "non_cash_received_other_desc", "non_cash_received_other_amount",
        "non_cash_provided_cheque_amount", "non_cash_provided_cheque_drawer",
        "non_cash_provided_money_order", "non_cash_provided_travellers_cheque",
        "non_cash_provided_remittance", "non_cash_provided_stored_value_card",
        "non_cash_provided_ecurrency_desc", "non_cash_provided_ecurrency_amount",
        "non_cash_provided_other_desc", "non_cash_provided_other_amount",
        "agent_name", "agent_austrac_id", "agent_abn",
    ...
    payload = {
        ...
        "report": {
            ...
            "customer": {
                ...
                "identification": {
                    "type": detail.get("customer_id_type_code") or report.customer_id_type,
                ...
                } if report.customer_id_number else None,
                "indOcc": {
                    "description": detail.get("customer_ind_occ_description"),
                } if detail.get("customer_ind_occ_description") else None,
                "account": {
                    "title": report.account_name,         # maxLength 140
                    "number": report.account_number,       # maxLength 34
                    "bsb": report.account_bsb,             # FBS only — optional
                } if report.account_number else None,
            },
            "individualConductingTxn": {
                "sameAsCustomer": detail.get("individual_conducting_txn_same_as_customer", True),
                ...
                } if detail.get("individual_conducting_txn_id_number") else None,
                "mainAddress": {
                ...
                } if detail.get("individual_conducting_txn_address") else None,
            },
...
def _build_money_section(direction: str, report: TTRReport, detail: dict, industry) -> dict:
    ...
    cash_key = f"money_{suffix_i}_aud_cash" if direction == "received" else f"money_{suffix_nc}_aud_cash"
    ...
    return {
        "cash": {
            ...
            "foreignCash": {
                "currency": detail.get("receive_currency") or detail.get("money_received_foreign_currency_code"),
                "amount": detail.get("amount_receive_foreign") or detail.get("money_received_foreign_amount"),
            } if detail.get("money_received_foreign_currency_code") or detail.get("receive_currency") else None,
        } if detail.get(cash_key) else None,
    }
