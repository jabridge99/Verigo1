...
IMPORT_FIELDS = [
    ...
    ("full_name",
     ["full_name", "name", "fullname", "customer_name", "applicant_name",
      "oc_full_name", "ordering_customer_name", "sender_name"],
    ...
    ("email",
     ["email", "email_address", "e-mail", "applicant_email", "contact_email",
      "oc_email", "sender_email"],
    ...
    ("phone",
     ["phone", "mobile", "phone_number", "mobile_number", "contact_number",
      "telephone", "oc_phone", "sender_phone"],
    ...
    ("occupation",
     ["occupation", "job_title", "profession", "employment", "oc_occupation", "sender_occupation"],
     False, "Accountant", "",
     "Current occupation or profession. Aligns with IFTI-DRA orderingCustomer.occupation."),

    ("employer_name",
     ["employer_name", "employer", "company", "business_name", "organisation",
      "organization", "oc_business_name"],
    ...
    ("id1_type",
     ...
     False, "Australian Driver Licence", "",
    ...
    ("id1_issuer",
     ["id1_issuer", "id_issuer", "issuing_authority", "oc_id1_issuer", "document_issuer"],
     False, "VIC", "",
    ...
    ("business_structure",
     ["business_structure", "entity_structure", "oc_business_structure", "bc_business_structure"],
     False, "", "Proprietary Company",
    ...
    ("address_line1",
     ["address_line1", "address", "street_address", "street", "addr1",
      "oc_address", "sender_address", "residential_address"],
    ...
    ("mail_address_line1",
     ["mail_address_line1", "postal_address", "mailing_address", "oc_postal_address"],
     False, "", "",
    ...
    ("bc_full_name",
     ["bc_full_name", "beneficiary_name", "recipient_name", "transferee_name", "payee_name"],
     False, "", "ABC Beneficiary Ltd",
    ...
    ("bc_email",
     ...
     False, "", "info@abc.co.nz",
     "Beneficiary email. Aligns with IFTI-DRA transferee.email."),

    ("bc_account_number",
     ["bc_account_number", "beneficiary_account", "recipient_account", "payee_account"],
     False, "", "00123456",
    ...
    ("bc_institution_country",
     ["bc_institution_country", "beneficiary_bank_country", "recipient_bank_country"],
     False, "", "NZ",
