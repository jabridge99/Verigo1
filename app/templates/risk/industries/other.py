    ...
    return RiskLibrary(
        ...
        factors=[
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Do not provide services until identity verified",
            ...
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Source-of-funds declaration above threshold",
            ...
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Jurisdiction risk rating maintained",
            ...
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Customer baseline profiling at onboarding",
                    "Alert on significant deviation from expected activity",
                ],
            ),
            LibraryFactor(
                ref="REG-001",
