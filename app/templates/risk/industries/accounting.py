    ...
    return RiskLibrary(
        ...
        factors=[
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Beneficial ownership mapping for all structures",
                    "Source of wealth documentation for HNWI clients",
                ],
            ),
            LibraryFactor(
                ref="CUST-002",
                ...
                mitigation_examples=[
                    "PEP screening at client onboarding",
                    "Senior partner sign-off for PEP engagements",
                ],
            ),
            LibraryFactor(
                ref="SERV-001",
                ...
                mitigation_examples=[
                    "Beneficial ownership declaration before company formation",
                    "Refuse to create nominee/bearer share structures",
                ],
            ),
            LibraryFactor(
                ref="SERV-002",
                ...
                mitigation_examples=[
                    "Strict trust account reconciliation",
                    "Investigate any unexplained client fund movements",
                ],
            ),
            LibraryFactor(
                ref="TXN-001",
                ...
                mitigation_examples=[
                    "Fee reasonableness review policy",
                    "Refund unexplained overpayments; do not retain",
                ],
            ),
            LibraryFactor(
                ref="REG-001",
                ...
                mitigation_examples=[
                    "All partners and staff complete AML/CTF training",
                    "Designate MLRO within firm",
                    "Enrol with AUSTRAC before providing designated services",
                ],
            ),
        ],
    )
