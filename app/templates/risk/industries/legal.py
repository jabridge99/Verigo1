    ...
    return RiskLibrary(
        ...
        factors=[
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Mandatory UBO identification for all entity clients",
                    "Refuse to act where UBO cannot be identified",
                ],
            ),
            LibraryFactor(
                ref="CUST-002",
                ...
                mitigation_examples=[
                    "Partner approval for all PEP matters",
            ...
            LibraryFactor(
                ...
                mitigation_examples=[
                    "Source of funds verification before settlement",
                    "Beneficial ownership verification for purchasing entities",
                    "Decline cash settlement payments",
                ],
            ),
            LibraryFactor(
                ref="SERV-002",
                ...
                mitigation_examples=[
                    "No nominee director/shareholder arrangements",
                    "Register UBO before structure established",
                    "Decline bearer share structures",
                ],
            ),
            LibraryFactor(
                ref="SERV-003",
                ...
                mitigation_examples=[
                    ...
                    "Investigate unexplained third-party deposits",
                    "Report suspicious movements via SMR",
                ],
            ),
            LibraryFactor(
                ref="TXN-001",
                ...
                mitigation_examples=[
                    "Require written explanation for third-party payments",
                    "CDD on third-party payers",
                ],
            ),
            LibraryFactor(
                ref="REG-001",
                ...
                description="Non-compliance with Tranche 2 obligations applicable to law firms from 1 July 2026.",
                suggested_likelihood=3,
                suggested_consequence=4,
                rationale="The legal sector is newly regulated and unfamiliar with AML/CTF obligations.",
                mitigation_examples=[
                    "Appoint MLRO (senior partner responsibility)",
                    "Staff-wide AML training before 1 July 2026",
                    "AUSTRAC enrolment for designated legal services",
                ],
            ),
        ],
    )
