...
function PricingPreview({ prices }: { prices: Record<string, PlanPrice> }) {
  const plans = [
    {
      name: 'Starter',
      price: formatAud(prices.starter.annual_aud),
      period: prices.starter.annual_aud != null ? '/yr' : '',
      badge: null,
      desc: 'For small reporting entities building their first AML/CTF programme.',
      features: ['Up to 500 customers', 'KYC & KYB verification', 'AML/CTF Program template', 'SMR & TTR reporting', 'AML transaction monitoring', 'Essential integrations'],
    ...
    {
      name: 'Professional',
      price: formatAud(prices.professional.annual_aud),
      period: prices.professional.annual_aud != null ? '/yr' : '',
      badge: 'Most Popular',
      desc: 'For growing compliance teams with full AUSTRAC reporting obligations.',
      features: ['Everything in Starter', 'IFTI IN, OUT & bulk import', 'Sanctions, PEP & adverse media', 'Advanced rule builder', 'MLRO case management', 'Workflow automation', 'AML data connectors'],
      cta: 'Start Free Trial',
      href: '/start-trial',
      highlight: true,
    },
    {
      ...
      features: ['Everything in Professional', 'Unlimited customers & users', 'Up to 2 compliance packs', 'White-label branding', 'Dedicated account manager', '99.9% uptime SLA'],
      cta: 'Start Free Trial',
      href: '/start-trial',
      highlight: false,
    },
