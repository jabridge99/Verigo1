    ...
    <div className="px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          ...
          <KPI label="IR Findings (open)" value={d.governance.open_findings_total} icon={AlertTriangle} color="bg-red-500/10 text-red-400" sub={`${(d.governance.open_findings_by_risk as any)?.critical ?? 0} critical`} href="/governance/risk-matrix?findings=open" />
